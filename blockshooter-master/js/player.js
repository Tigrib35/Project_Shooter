...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const updateView = () => {
    ...
    document.querySelector("#ammo").textContent = currentAmmo;
    document.querySelector("#health").textContent = currentHealth;
    document.querySelector("#armor").textContent = currentArmor;

    document
      .querySelector("#powerup-badges .badge.jetpack")
      ?.style?.setProperty?.("--powerup-progress", currentFuel / MAX_FUEL);

    document
      .querySelector("#powerup-badges .badge.bricks")
      ?.style?.setProperty?.("--powerup-progress", currentBlocks / MAX_BLOCKS);
